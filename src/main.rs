...
async fn main() -> std::io::Result<()> {
    ...
    HttpServer::new(move || {
        let cors = Cors::default()
            ...
            .allowed_origin("https://raum-martin.micedric.dpdns.org:9001")
            .allowed_origin("https://raum-api.micedric.dpdns.org:9001")
            .allowed_origin("https://raum-vue.micedric.dpdns.org:9001")
            .allowed_origin("https://raum-martin.micedric.dpdns.org:9001")
